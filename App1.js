...
import { BasicText } from "./app/styled_components/elements/Text";
...
const TweetDetails = ({ route }) => (
  <Screen>
    <BasicText>TweetDetails</BasicText>
    <BasicText>this is what i tweeted! {route.params.id}</BasicText>
  </Screen>
);
...
const Link = () => {
  ...
  return (
    <Button
      title="Click"
      onPress={() => navigation.navigate("Tweet Details", { id: 9992 })}
    />
  );
};
